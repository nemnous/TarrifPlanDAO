...
public class TarrifPlan {
	...
	TarrifPlan(String name, String typeOfPlan, Double tarrif, int validity, Double rental) {
		this.name  = name;
	...
	public String toString() {
		return this.name + " " + this.typeOfPlan + " " + this.tarrif.toString() + " " + Integer.toString(this.validity)  + " " + this.rental.toString();
	}
